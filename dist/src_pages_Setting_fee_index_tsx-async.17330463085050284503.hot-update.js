globalThis.makoModuleHotUpdate('src/pages/Setting/fee/index.tsx', {
    modules: {
        "src/services/setting/fee.ts": function(module, exports, __mako_require__) {
            ...
            const _updateVendPopupsFee = async (values)=>{
                return (0, _max.request)("/api/v1/admin/private/fee/update", {
                    method: "post",
                    data: {
                        vendpopups: {
                            ...values
    ...
    runtime._h = '15472449495960744602';
    ;
});

//# sourceMappingURL=src_pages_Setting_fee_index_tsx-async.17330463085050284503.hot-update.js.map