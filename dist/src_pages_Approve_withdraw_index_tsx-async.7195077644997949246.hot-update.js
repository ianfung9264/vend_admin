globalThis.makoModuleHotUpdate('src/pages/Approve/withdraw/index.tsx', {
    modules: {
        "src/services/withdrawal/info.ts": function(module, exports, __mako_require__) {
            ...
            const _rejectWithdrawal = async (data)=>{
                return (0, _max.request)(`/api/v1/admin/private/withdrawal/${data.id}`, {
                    method: "put",
                    params: {
            ...
            const _updateWithdrawalProgress = async (id)=>{
    ...
    runtime._h = '11077134652827451732';
    ;
});

//# sourceMappingURL=src_pages_Approve_withdraw_index_tsx-async.7195077644997949246.hot-update.js.map