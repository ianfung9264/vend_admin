globalThis.makoModuleHotUpdate('src/pages/Setting/fee/index.tsx', {
    modules: {
        "src/pages/Setting/fee/index.tsx": function(module, exports, __mako_require__) {
            ...
            function Index() {
                ...
                const { loading, error } = (0, _max.useRequest)(_fee._getAllFee, {
                    onSuccess: (res)=>{
            ...
            _s(Index, "JP8++12gT2X3mzGpH7S5ZVGI43w=", false, function() {
                return [
                    _max.useRequest
                ];
            });
    ...
    runtime._h = '11949209299980575057';
    ;
});

//# sourceMappingURL=src_pages_Setting_fee_index_tsx-async.17853250806175954732.hot-update.js.map