globalThis.makoModuleHotUpdate('src/pages/Setting/faq/index.tsx', {
    modules: {
        "src/pages/Setting/faq/detailModal.tsx": function(module, exports, __mako_require__) {
            ...
            function DetailModal({ initData, mainTableReload }) {
                var _formRef_current, _formRef_current1;
                _s();
                ...
                /**********************************異步函數**********************************/ return /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_BaseModel.default, {
                    modalFormProps: {
                        ...
                        onInit: async (values, form)=>{
                            ...
                            (_formRef_current = formRef.current) === null || _formRef_current === void 0 ? void 0 : _formRef_current.submit = form.submit;
                        },
                    ...
                    submit: (_formRef_current1 = formRef.current) === null || _formRef_current1 === void 0 ? void 0 : _formRef_current1.submit,
                    allowUpdate: true,
                    title: "Faq Details",
    ...
    runtime._h = '840451872202348905';
    ;
});

//# sourceMappingURL=src_pages_Setting_faq_index_tsx-async.5537585044147407477.hot-update.js.map