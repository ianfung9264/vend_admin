globalThis.makoModuleHotUpdate('src/pages/Setting/faq/index.tsx', {
    modules: {
        "src/pages/Setting/faq/detailModal.tsx": function(module, exports, __mako_require__) {
            ...
            function DetailModal({ initData, mainTableReload }) {
                var _formRef_current, _formRef_current1, _formRef_current2;
                _s();
                /**********************************狀態管理**********************************/ const formRef = (0, _react.useRef)();
                const [submitFun, setSubmitFun] = (0, _react.useState)((_formRef_current = formRef.current) === null || _formRef_current === void 0 ? void 0 : _formRef_current.submit);
                (0, _react.useEffect)(()=>{
                    console.log("formRef", formRef);
                }, [
                    (_formRef_current1 = formRef.current) === null || _formRef_current1 === void 0 ? void 0 : _formRef_current1.getFieldValue("_id")
                ]);
                ...
                /**********************************異步函數**********************************/ return /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_BaseModel.default, {
                    ...
                    submit: (_formRef_current2 = formRef.current) === null || _formRef_current2 === void 0 ? void 0 : _formRef_current2.submit,
                    allowUpdate: true,
                    title: "Faq Details",
            ...
            _s(DetailModal, "eqvZYz2XR+tmvcoukRD9dBvim8w=");
            _c = DetailModal;
            var _c;
    ...
    runtime._h = '13502804457599370024';
    ;
});

//# sourceMappingURL=src_pages_Setting_faq_index_tsx-async.11996391064189468442.hot-update.js.map