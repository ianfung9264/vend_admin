globalThis.makoModuleHotUpdate('src/pages/Setting/faq/index.tsx', {
                ...
                /**********************************異步函數**********************************/ return /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_BaseModel.default, {
                    modalFormProps: {
                        ...
                        onFinish: async (value)=>{
                            if (initData) {
                                value.id = initData === null || initData === void 0 ? void 0 : initData._id;
                                try {
                    ...
                    submit: (_formRef_current = formRef.current) === null || _formRef_current === void 0 ? void 0 : _formRef_current.submit(),
                    allowUpdate: true,
                    initData: org,
                    title: "Faq Details",
    ...
    runtime._h = '11738172181033751151';
    ;
});

//# sourceMappingURL=src_pages_Setting_faq_index_tsx-async.14235383398995825770.hot-update.js.map