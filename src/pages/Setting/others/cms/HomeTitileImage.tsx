...
import { HOME_TITLE_IMAGE_ID } from "../../../../../config/cmsId";
...
export default function HomeTitleImage() {
  /**********************************狀態管理**********************************/
  const [homeTitleImage, setHomeTitleImage] = useState("");
  ...
  const getHomeTitleImage = async () => {
    await _getCMSImage(HOME_TITLE_IMAGE_ID).then((res) => {
