...
import { HOME_FOOTER_IMAGE_ID } from "../../../../../config/cmsId";
import React, { useEffect, useState } from "react";
export default function HomeFooterImage() {
  /**********************************狀態管理**********************************/
  const [homeFooterImage, setHomeFooterImage] = useState("");
  ...
  const props: UploadProps = {
    ...
    onChange: async (info) => {
      ...
      if (file) {
        ...
        try {
          setLoading(true);
          const response = await _updateCMSImage({
            file: file,
            session: HOME_FOOTER_IMAGE_ID,
          });
          if (response.status) {
  ...
  const getHomeFooterImage = async () => {
    await _getCMSImage(HOME_FOOTER_IMAGE_ID).then((res) => {
