...
import { WithdrawalProgress, WithdrawalProgressNoRejected } from "@/services/commonType";
import { _rejectWithdrawal, _updateWithdrawalProgress } from "@/services/withdrawal/info";
	...
	return (
		...
		>
			<ProForm.Group style={groupStyle}>
				<ProFormSelect
					label="Select withdrawal status"
