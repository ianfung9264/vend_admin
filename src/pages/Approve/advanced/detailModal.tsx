    ...
    >
      ...
      <ProForm.Group style={{ ...groupStyle }}>
        ...
        <ProFormField label={"Icon"} name="icon_url" colProps={rightFile}>
          {org?.icon_url?.url && <Image src={org.icon_url.url} width={100} />}
        </ProFormField>
        ...
        <ProFormSelect
          ...
          valueEnum={{
            ...
            1: { text: "Waiting For Admin Approval", status: "Processing" },
        ...
        <ProFormField
          ...
          colProps={leftFile}
        >
          {org?.event_operation_license?.url && (
        ...
        <ProFormField
          ...
          colProps={rightFile}
        >
          {org?.terms_and_conditions?.url && (
            <Image src={org.terms_and_conditions.url} width={100} />
          )}
        </ProFormField>
      </ProForm.Group>
      ...
      <ProForm.Group style={{ ...groupStyle }}>
        ...
        >
          {org?.pictures?.map(
            (pic: any) =>
              pic?.url && <Image key={pic.url} src={pic.url} width={100} />
          )}
        </ProFormField>
      </ProForm.Group>
